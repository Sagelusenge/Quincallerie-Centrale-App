...
Ce dossier contient la documentation ecrite du backend. Il sert aux developpeurs frontend/mobile, aux personnes qui configurent le projet et a toute personne qui veut comprendre le fonctionnement de l'application.
