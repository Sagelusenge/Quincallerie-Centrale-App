  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200 bg-white/95 px-4 backdrop-blur dark:border-slate-800 dark:bg-slate-950/95 sm:px-6">
      <div className="flex items-center gap-3">
        <Button
          variant="ghost"
          className="h-14 w-14 px-0 py-0 min-h-0 lg:hidden"
          onClick={openMobile}
          aria-label="Menu"
        >
          <Menu size={50} />
      ...
      <div className="flex items-center gap-2">
        <Button
          variant="ghost"
          className="h-14 w-14 px-0 py-0 min-h-0"
          onClick={toggleTheme}
          aria-label="Theme"
        >
        ...
        <Button
          variant="ghost"
          className="h-14 w-14 px-0 py-0 min-h-0 text-rose-600 hover:bg-rose-100 dark:text-rose-200 dark:hover:bg-rose-950"
